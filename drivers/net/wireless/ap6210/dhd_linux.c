...
dhd_module_cleanup(void)
{
	...
	/*sw_rfkill_exit(); The comment must remove when we use the Bluetooth<BPI Team >*/ 
...
dhd_module_init(void)
{
	...
	AP6210_DEBUG("%s: Enter\n", __FUNCTION__);
   AP6210_INFO("--->The Drive has been modified for BananaPI_M1_Plus by BPI team<---\n");

	ap6210_gpio_wifi_init();
	/*sw_rfkill_init(); The comment must remove when we use the Bluetooth<BPI>*/
